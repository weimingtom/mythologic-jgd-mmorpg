...
public class MythologicClient extends JFrame implements SimpleClientListener,
		ActionListener {
	 ...
	 */
	public MythologicClient() {
		this(MythologicClient.class.getSimpleName());
	}
	 ...
	 */
	protected MythologicClient(String title) {
		super(title);
	...
	/**
	 * Allows subclasses to populate the input panel with additional UI
	 * elements. The base implementation simply adds the input text field to the
	 * center of the panel.
	 * 
	 * @param panel
	 ...
	 * 
	 * @param x
	 *            the message to append to the output text pane
	 */
	 ...
	 * password is "guest." Real-world clients are likely to pop up a login
	 * dialog to get these fields from the player.
	 */
	...
	/**
	 * A ClientChannelListener that does nothing at all (this basic client does
	 * not support channels).
	 */
	private static class NullClientChannelListener implements
